...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    footer = '<div class="modal-footer customFT"' + (this.options.footer ? '' : ' style="display:none"') + '>' + this.options.footer + '</div>';
  ...
  EkkoLightbox.prototype = {
    ...
    showVideoIframe: function(url, width, height) {
      ...
      this.options.onContentLoaded.call(this);
      if (this.modal_arrows) {
        this.modal_arrows.css('display', 'block');
      }
      return this;
    },
  ...
  $.fn.ekkoLightbox.defaults = {
	...
	left_arrow_class: '.ModalNavLeft',
    right_arrow_class: '.ModalNavRight',
